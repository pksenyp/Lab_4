...
void realtor::add_flat(Flat aflat)
{
	if (num_flats < max_num_flats) // can we add another apartment?
	{
		flats[num_flats] = aflat; // bringing the apartment into the array
		num_flats++; // Increase the apartment counter
	}
}
